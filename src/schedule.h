	...
	{244, 
		{
			...
			{TIME(6,01), 5, TYPE_END},
			{TIME(6,31), 5, TYPE_END},
			{TIME(7,01), 5, TYPE_END},
			{TIME(7,29), 5, TYPE_END},
			{TIME(8,01), 5, TYPE_END},
			{TIME(8,25), 5, TYPE_END},
			{TIME(9,01), 5, TYPE_END},
			{TIME(10,04), 5, TYPE_END},
			{TIME(11,04), 5, TYPE_END},
			{TIME(12,04), 5, TYPE_END},
			{TIME(13,04), 5, TYPE_END},
			{TIME(14,04), 5, TYPE_END},
			{TIME(15,04), 5, TYPE_END},
			{TIME(16,04), 5, TYPE_END},
			{TIME(17,04), 5, TYPE_END},
			{TIME(18,04), 5, TYPE_END},
			{TIME(19,04), 5, TYPE_END},
			{TIME(20,04), 5, TYPE_END},
			{TIME(21,04), 5, TYPE_END},
		}
	},
	{240, 
		{
			...
			{TIME(14,06), 10, TYPE_START},
			{TIME(14,39), 10, TYPE_START},
			{TIME(15,06), 10, TYPE_START},
			{TIME(15,20), 10, TYPE_START},
			{TIME(15,39), 10, TYPE_START},
			{TIME(16,06), 10, TYPE_START},
			{TIME(16,39), 10, TYPE_START},
			{TIME(17,06), 10, TYPE_START},
			{TIME(17,20), 10, TYPE_START},
			{TIME(17,39), 10, TYPE_START},
			{TIME(18,06), 10, TYPE_START},
